...
export default function Landing() {
  return (
    <section className="relative isolate mx-auto flex min-h-screen w-full max-w-7xl items-center overflow-hidden pt-10 md:pt-0">
      <div className="relative z-20 flex max-w-3xl flex-col gap-10">
        ...
        <div className="flex flex-wrap items-center gap-5">
          <button
            className="border border-transparent bg-zinc-100 px-7 py-4 text-base font-semibold uppercase tracking-wide text-zinc-900"
            type="button"
          >
            View Projects
          </button>
